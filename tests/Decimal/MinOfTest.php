...
final class MinOfTest extends TestCase
{
    ...
    #[Test]
    public function returnsIntProjectionOfMin(): void
    {
        $this->assertSame(
            1,
            (new MinOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asInt(),
        );
    }

    #[Test]
    public function returnsFloatProjectionOfMin(): void
    {
        $this->assertSame(
            1.5,
            (new MinOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asFloat(),
        );
    }

    #[Test]
    public function returnsTextProjectionOfMin(): void
    {
        $this->assertSame(
            '1.5',
            (new MinOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asText()->value(),
        );
    }
}
