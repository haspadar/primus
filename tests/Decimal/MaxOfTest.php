...
final class MaxOfTest extends TestCase
{
    ...
    #[Test]
    public function returnsIntProjectionOfMax(): void
    {
        $this->assertSame(
            2,
            (new MaxOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asInt(),
        );
    }

    #[Test]
    public function returnsFloatProjectionOfMax(): void
    {
        $this->assertSame(
            2.7,
            (new MaxOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asFloat(),
        );
    }

    #[Test]
    public function returnsTextProjectionOfMax(): void
    {
        $this->assertSame(
            '2.7',
            (new MaxOf(new DecimalOf('1.5'), new DecimalOf('2.7'), 1))->asText()->value(),
        );
    }
}
